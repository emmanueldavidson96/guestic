...
function Explore() {
  return (
    <div className='w-full flex h-screen bg-center bg-cover relative '>
        <Image src={background_img} className='w-full h-full object-cover '/>
        ...
        <div className='flex flex-col gap-6 absolute top-[350px] left-[120px] w-[550px] text-left items-start z-20'>
            ...
            <p className='font-medium text-lg'>
                Immerse yourself in the unparalled comfort and convenience of our hotel's amenities. Watch the video below to discover the indulgent
