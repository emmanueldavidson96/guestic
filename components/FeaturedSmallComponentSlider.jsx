...
export default function FeaturedSmallComponentSlider({data}) {
  ...
  return (
    <div className='flex justify-center items-center w-full h-[300px] relative bg-white overflow-hidden'>
