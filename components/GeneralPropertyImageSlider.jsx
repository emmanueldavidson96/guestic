...
export default function GeneralPropertyImageSlider({data}) {
  ...
  const prevSlide = () => {
    ...
    return (
    <div className='flex justify-center items-center w-full h-[380px] relative bg-white overflow-hidden'>
